...
// * The last 2 parameters could be passed as a single 2nd parameter wrapped in an object with apropiate property names and values
...
SofiaTree.prototype.getCompletions= function(origPrefix, excludePrefix, maxResults){
	...
	//Support for the options parameter
	if(typeof excludePrefix == 'object'){
		maxResults = excludePrefix.maxResults || Number.POSITIVE_INFINITY; 
		excludePrefix = !!excludePrefix.excludePrefix; 
	}else{
		if(typeof maxResults == 'number')
			maxMatches = excludePrefix ? maxResults +1 : maxResults;
		else 
